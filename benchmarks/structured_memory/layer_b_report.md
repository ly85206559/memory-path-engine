...
Fixtures: spatial_recall_benchmark.json, route_replay_benchmark.json, state_transition_benchmark.json, encoding_recall_benchmark.json, consolidation_gain_benchmark.json, exception_override_benchmark.json, exception_override_path_benchmark.json, contradiction_tension_benchmark.json, multi_hop_chain_benchmark.json, activation_snapshot_benchmark.json
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| weighted_graph | 1.000 | 3 | 1.000 | 2 | 1.000 | 1 | 1.000 | 1 | 1.000 | 1 | 1.000 | 1 |
| activation_spreading_v1 | 1.000 | 3 | 1.000 | 2 | 1.000 | 1 | 1.000 | 1 | 1.000 | 1 | 1.000 | 1 |
